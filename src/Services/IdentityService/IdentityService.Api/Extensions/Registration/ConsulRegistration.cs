...
namespace IdentityService.Api.Extensions.Registration
{
    public static class ConsulRegistration
    {
        ...
        public static IApplicationBuilder ConfigureConsul(this IApplicationBuilder applicationBuilder, IHostApplicationLifetime lifetime)
        {
            ...
            var registration = new AgentServiceRegistration()
            {
                ...
                Address = $"{uri.Host}",
                Port = uri.Port,
                Tags = new[] { "Identity Service", "Identity" , "Token" }
            };
